  ...
  return (
    <div className="productos">
      ...
      <div className="producto">
        ...
        <div className="producto__footer">
          <h1>Seis (6) tequeños queso y panceta fritos mas salsa de ajo</h1>
          <p className="price">$ 4.000</p>
          <h1>Doce (12) tequeños queso y panceta fritos mas salsa de ajo</h1>
          <p className="price">$ 7.200</p>
          <p>Fritos</p>
        </div>
      </div>
      ...
      <div className="producto">
        ...
        <div className="producto__footer">
          ...
          <p className="price">$ 3.600 tapa p/llevar</p>
        </div>
      </div>
      ...
      <div className="producto">
        ...
        <div className="producto__footer">
          <h1>Chicha</h1>
          <p>Bebidas</p>
          <p className="price">$ 900 vaso 300 cc</p>
          <p className="price">$ 1.500 vaso 300 cc con tapa p/llevar</p>
        </div>
      </div>
      ...
      <div className="producto">
        ...
        <div className="producto__footer">
          ...
          <p>Alimentos</p>
          <p className="price">$ 5.250 x kg</p>
        </div>
      </div>
